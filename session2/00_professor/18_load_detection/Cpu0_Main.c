...
void CCU60_T12_ISR(void)
{
    ...
    cur_RPM = (float)(rotate*30);
    diff = cur_RPM - pre_RPM;

    // minimum toggle interval = 2 sec
    if( (diff/dt > 1000 || diff/dt < -1000) && cnt > 20 ) {
        motor_direction ^= 0x1;
        cnt = 0;
    }


    P10_OUT.B.P2 = motor_direction;
//    Ifx_Console_print("%d %d\n\r", (unsigned int)cur_RPM, motor_direction);
...
void initCCU60(void)
{
    ...
    CCU60_T12PR.B.T12PV = 4882 - 1;     // PM interrupt freq. = f_T12 / (T12PR + 1)
